...
public class CachedRowSet extends Frame implements Runnable, WindowListener {
    Panel Info;
    TextField textQuery;
    Label label1;
    ...
    int columnCount;
    String connectionURL = "jdbc:virtuoso://localhost:1111/UID=dba/PWD=dba";
    String[][] data;
    ...
    void NewThread_Action() {
        try {
            CachedRowSet p = new CachedRowSet();
            new Thread(p).start();
        } catch (Exception e) {
    ...
    void buttonOriginalAll_Clicked() {
        try {
            result.setOriginal();
            updateInfo();
        } catch (Exception e) {
    ...
    void buttonOriginalRow_Clicked() {
        try {
    ...
    void buttonRestoreOriginal_Clicked() {
        try {
    ...
    static public void main(String args[])
            throws Exception {
        CachedRowSet sd = new CachedRowSet();
        if (args.length > 0)
    ...
    class BActionListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (c == buttonQuery)
                buttonQuery_Clicked();
            else if (c == buttonAccept)
                buttonAccept_Clicked();
            else if (c == buttonFirst)
                buttonFirst_Clicked();
            else if (c == buttonPrevious)
                buttonPrevious_Clicked();
            else if (c == buttonNext)
                buttonNext_Clicked();
            else if (c == buttonLast)
                buttonLast_Clicked();
            else if (c == buttonDelete)
                buttonDelete_Clicked();
            else if (c == buttonRefresh)
                buttonRefresh_Clicked();
            else if (c == buttonInsert)
                buttonInsert_Clicked();
            else if (c == buttonUpdate)
                buttonUpdate_Clicked();
            else if (c == buttonAbsolute)
                buttonAbsolute_Clicked();
            else if (c == buttonRelative)
                buttonRelative_Clicked();
            else if (c == buttonCancelDel)
                buttonCancelDel_Clicked();
            else if (c == buttonCancelIns)
                buttonCancelIns_Clicked();
            else if (c == buttonCancelUpd)
                buttonCancelUpd_Clicked();
            else if (c == buttonOriginalAll)
                buttonOriginalAll_Clicked();
            else if (c == buttonOriginalRow)
                buttonOriginalRow_Clicked();
            else if (c == buttonRestoreOriginal)
                buttonRestoreOriginal_Clicked();
        }
    }
