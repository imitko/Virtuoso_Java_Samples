  ...
  void bOk_actionPerformed(ActionEvent e) {
    if (data != null) {
       if (R_singleThreaded.isSelected())
          ...
          try {
            data.tpca.nThreads = Integer.parseInt(numThreads.getText());
          } catch(Exception ex) {
            data.tpca.nThreads = 1;
          }
       if (! C_Batch.isSelected())
          ...
          try {
            data.tpca.nBatchSize = Integer.parseInt(nBatchSize.getText());
          } catch(Exception ex) {
            data.tpca.nBatchSize = 1;
          }
       if (R_scNone.isSelected())
          ...
          try {
            data.tpca.travCount = Integer.parseInt(traversalCount.getText());
          } catch(Exception ex) {
            data.tpca.travCount = 1;
          }
